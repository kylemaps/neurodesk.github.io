...
<img src="{{ "/static/docs/getting-started/hosted/github_codespace.png" | relURL }}" alt="Start GitHub Codespace" width="500">
...
<img src="{{ "/static/docs/getting-started/hosted/github_codespace_open.png" | relURL }}" alt="Pop up on GitHub Codespace" width="400">
